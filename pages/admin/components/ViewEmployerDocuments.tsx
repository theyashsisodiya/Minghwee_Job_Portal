...
import { MOCK_ADMIN_EMPLOYER_DOCS } from '../../../constants';
import { AdminPage } from '../AdminDashboard';

interface ViewEmployerDocumentsProps {
    navigate: (page: AdminPage) => void;
}

const ViewEmployerDocuments: React.FC<ViewEmployerDocumentsProps> = ({ navigate }) => {
    const documentsByCategory: { [key: string]: typeof MOCK_ADMIN_EMPLOYER_DOCS } = 
        MOCK_ADMIN_EMPLOYER_DOCS.reduce((acc, doc) => {
            (acc[doc.category] = acc[doc.category] || []).push(doc);
            return acc;
        }, {} as { [key: string]: typeof MOCK_ADMIN_EMPLOYER_DOCS });
    ...
    return (
        <div>
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">BuildWell Construction</h1>
            <p className="text-gray-500 mb-8">Documents</p>
...
export default ViewEmployerDocuments;
