      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-purple-50">
            <div className="container mx-auto px-6 text-center max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Pricing for Hiring a Foreign Domestic Worker (FDW)</h1>
        ...
        <section className="py-16 bg-white">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-purple-100 overflow-hidden flex flex-col">
                        <div className="bg-purple-600 p-6 text-white text-center">
                            <h2 className="text-2xl font-bold">1. Full Payment Option</h2>
                            <p className="opacity-90 mt-2">Best for immediate hiring</p>
                        </div>
                        <div className="p-8 flex-grow">
                            ...
                            <div className="mb-6">
                                <h3 className="font-bold text-purple-800 mb-3">What’s Included:</h3>
                                <ul className="space-y-2">
                                    {['Agency Fees', 'MOM Work Permit Fees', 'Security Bond & Insurance', 'Medical & SIP Costs', 'Monthly Levy (standard $300 or concessionary $60)', 'FDW Monthly Salary ($500-$800)'].map(item => (
                                        <li key={item} className="flex items-start">
                                            <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                            ...
                            <div>
                                <h3 className="font-bold text-purple-800 mb-3">Benefits:</h3>
                                <ul className="space-y-2">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-purple-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                                        <span className="text-gray-700 text-sm">Immediate activation of hiring process</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-purple-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        <span className="text-gray-700 text-sm">Document collection starts immediately</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-purple-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        <span className="text-gray-700 text-sm">Faster timeline for onboarding</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    {/* Option 2: Booking Fee */}
                    <div className="bg-white rounded-2xl shadow-xl border border-pink-100 overflow-hidden flex flex-col">
                        <div className="bg-pink-500 p-6 text-white text-center">
                            <h2 className="text-2xl font-bold">2. Booking Fee Option</h2>
                            <p className="opacity-90 mt-2">Reserve now, decide later</p>
                        </div>
                        <div className="p-8 flex-grow">
                            <p className="text-gray-600 mb-6">
                            ...
                            <div className="mb-6">
                                <h3 className="font-bold text-pink-700 mb-3">What’s Included:</h3>
                                <ul className="space-y-2">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                            ...
                            <div>
                                <h3 className="font-bold text-pink-700 mb-3">Benefits:</h3>
                                <ul className="space-y-2">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-pink-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                        <span className="text-gray-700 text-sm">Reserve a candidate for 7 days</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-pink-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        <span className="text-gray-700 text-sm">No commitment until you're ready</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 text-pink-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                    ...
                    <div className="flex justify-center gap-8 flex-wrap">
                        <div className="flex flex-col items-center">
                            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-2">
                                <svg className="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                            </div>
                            <span className="font-semibold text-gray-700">PayNow</span>
                        </div>
                         <div className="flex flex-col items-center">
             ...
             <div className="container mx-auto px-6 max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                         <div className="w-16 h-16 mx-auto bg-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-4">1</div>
                         <h3 className="text-xl font-bold mb-2">Select Payment Option</h3>
                         <p className="text-gray-600">Choose between full payment or booking fee.</p>
                    </div>
                    <div className="text-center">
                         <div className="w-16 h-16 mx-auto bg-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-4">2</div>
                     ...
                     <div className="text-center">
                         <div className="w-16 h-16 mx-auto bg-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-4">3</div>
                         <h3 className="text-xl font-bold mb-2">Hiring Process Starts</h3>
                         <p className="text-gray-600">Upon payment confirmation, your hiring process is activated. You will receive a receipt, and the next steps will begin.</p>
                    </div>
                </div>
             </div>
        </section>
        ...
        {/* CTA */}
        <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-center text-white">
             <div className="container mx-auto px-6">
